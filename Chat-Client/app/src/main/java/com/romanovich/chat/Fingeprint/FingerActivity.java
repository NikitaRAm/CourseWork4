package com.romanovich.chat.Fingeprint;
...
import com.romanovich.chat.Activity.RegisterActivity;
...
public class FingerActivity extends AppCompatActivity {
    ...
    public void watch_onClick(View view){
        startActivity(new Intent(FingerActivity.this, RegisterActivity.class));
    }
